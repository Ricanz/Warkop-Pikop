        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Founder</h1>


                    <div class="card shadow mb-4 p-4">
                        <form action="./lib/do_add_founder.php" method="POST" class="form-group" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title" placeholder="Masukkan Nama Founder">
                                </div>
                                <div class="col-sm-12 mb-2">
